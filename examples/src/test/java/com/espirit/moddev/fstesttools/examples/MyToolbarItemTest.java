...
import com.espirit.moddev.fstesttools.mocking.MockingToolbarContext;
...
public class MyToolbarItemTest {
    ...
    public void setUp() throws Exception {
        context = new MockingToolbarContext(Locale.ENGLISH, true, storeType, element,
                                            "My Test Project", BaseContext.Env.PREVIEW);
        testling = new MyToolbarItem();
    }
    ...
    @Test
    public void testGetPressedIcon() throws Exception {
        assertThat("Expect null value",testling.getPressedIcon(context), is(nullValue()));
    }

    @Test
    public void testGetRollOverIcon() throws Exception {
        assertThat("Expect null value",testling.getRollOverIcon(context), is(nullValue()));
    }
}
